...
const ProductDetailsPeach2 = () => {
  const [flavor, setFlavor] = React.useState("Peach Flavor");
  const { addToCart, setOpen2 } = useCart();
  const notifySuccess = () => toast.success("Successfully added to cart !");
  const imageSources = [
    require("../../assets/WHITE BGS/PEACH PAIR.webp"),
    require("../../assets/WHITE BGS/Skin101_Peach_1.webp"),
    require("../../assets/WHITE BGS/Skin101_Peach_2.webp"),
    require("../../assets/WHITE BGS/Skin101_Peach_3.webp"),
    require("../../assets/WHITE BGS/Skin101_Peach_4.webp"),
    require("../../assets/WHITE BGS/Skin101_Peach_5.webp"),
  ];
  ...
  const handleAddToCart = () => {
    ...
    } else if (selected === 2 && flavor === "Peach Flavor + Black Grape") {
  ...
  return (
    <>
      <Helmet>
        <title>
          Purchase Supplements for Healthy Skin Exclusively at Nuform
        </title>
        <meta
          name="title"
          content="Purchase Supplements for Healthy Skin Exclusively at Nuform"
        />
        <meta
          name="description"
          content="Reveal your most radiant skin with our breakthrough formula, enhancing clarity and brightness while eliminating mild acne and pigmentation. Order online now."
        />
      </Helmet>
      <div className="px-1 pt-6 lg:pt-10 md:px-0">
          ...
          <div className="relative md:w-1/2 ">
            ...
            <div className="flex justify-center w-full gap-4 select-none lg:justify-start">
              ...
              >
                ...
                >
                  Save {priceData["Skin101Peach2"].discount}
                </div>
              </div>{" "}
              <div
                onClick={() => {
              ...
              >
                ...
                >
                  Save {priceData["Skin101Peach1"].discount}
                </div>
              </div>
            </div>
            ...
            <div className="pt-4 my-4 ">
              ...
              >
                <FormControl fullWidth>
                  ...
                  >
                    {selected !== 1 && (
                      <MenuItem value={"Peach Flavor + Black Grape"}>
                        <div className="flex items-center gap-1 sm:gap-2 ">
                          <GiPeach className="text-[#FFE5B4]  " />
                          Peach & <LuGrape className="" />
                          Black Grape
            ...
            <div className="flex gap-4 ">
              ...
              <button
                aria-label="Add to cart"
                type="button"
                className="px-6 py-3 mt-2 duration-200 border rounded-full hover:text-white hover:bg-primary hover:scale-95 lg:w-full border-primary text-primary"
              >
                Add to Cart
              </button>
            </div> */}
        ...
        <FAQs />
        <Reviews id="66486d8ae4cd905411ae1c77" />
...
export default ProductDetailsPeach2;
